...
module.exports = {
    ...
    deleteAddressByFacilityId: async (req, res, next) => {
        try {
            const facilityId = req.params.facilityId;
            const result = await facilityService.deleteAddressByFacilityId(facilityId);
            res.status(200).json({
                status: 'success',
                data: result,
            });
    ...
    getOpeningHoursByFacilityId: async (req, res, next) => {
        try {
            const facilityId = req.params.facilityId;
            const openingHours = await facilityService.getOpeningHoursByFacilityId(facilityId);
            res.status(200).json({
                status: 'success',
                data: openingHours,
            });
    ...
    addOpeningHours: async (req, res, next) => {
        try {
            ...
            const result = await facilityService.addOpeningHours(facilityId, openingHours);
            res.status(201).json({
                status: 'success',
                data: result,
            });
    ...
    createMenu: async (req, res, next) => {
        try {
            ...
            const result = await facilityService.createMenu(req.params.facilityId, menuItems);
            res.status(201).json({
                status: 'success',
                data: result,
            });
    ...
    getStampRulesetRewardsByFacilityId: async (req, res, next) => {
        try {
            const facilityId = req.params.facilityId;
            const ruleset = await facilityService.getStampRulesetRewardsByFacilityId(facilityId);
            res.status(200).json({
                status: 'success',
                data: ruleset,
            });
    ...
    updateStampRuleset: async (req, res, next) => {
        try {
            const facilityId = Number(req.params.facilityId);
            const ruleset = await facilityService.updateStampRuleset(facilityId, req.body);
            res.status(201).json({
                status: 'success',
                data: ruleset,
            });
    ...
    createStampReward: async (req, res, next) => {
        try {
            const facilityId = Number(req.params.facilityId);
            const reward = await facilityService.createStampReward(facilityId, req.body);
            res.status(201).json({
                status: 'success',
                data: reward,
            });
    ...
    updateStampReward: async (req, res, next) => {
        try {
            ...
            const reward = await facilityService.updateStampReward(facilityId, rewardId, req.body);
            res.status(201).json({
                status: 'success',
                data: reward,
            });
    ...
    deleteStampReward: async (req, res, next) => {
        try {
            const facilityId = Number(req.params.facilityId);
            const rewardId = Number(req.params.rewardId);
            const result = await facilityService.deleteStampReward(facilityId, rewardId);
            res.status(200).json({
                status: 'success',
                data: result,
            });
