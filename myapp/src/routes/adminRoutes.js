...
router
    .get(       // GET : get report by id
        ...
        [
            ...
            query('status', `optional query field 'status' must be one of ${REPORT_STATUS}`).optional().isIn(REPORT_STATUS),
            validatorChecker,
        ],
        ...
        [
            ...
            body('reviewId', `optional body field 'reviewId' must be a positive integer`).optional().isInt({min: 1}),
            validatorChecker,
        ],
