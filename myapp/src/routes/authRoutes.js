...
router
    ...
    .post(      // POST : request email verification for KAIST user
    ...
    .post(      // POST : register new KAIST or facility user. KAIST user will require verification
        '/register',
        checkPermission([-1,0]),
        [
    ...
    .post(      // POST : verify KAIST user email & register
        '/verify-kaist',
        checkPermission([-1,0]),
        [
            body('userId', `body field 'userId' should be string`).exists().isString(),
